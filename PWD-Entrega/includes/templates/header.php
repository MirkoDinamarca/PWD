...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="sidebar">
            ...
            <div class="logo">
                <h3 style="color: white;"><a href="/PWD-Entrega/index.php"></a>Grupo N°9 - PWD</h3>
            </div>

            <ul class="list-unstyled menu-elements">
                <li>
                    <a href="#otherSections" data-bs-toggle="collapse" aria-expanded="false" class="" role="button" aria-controls="otherSections">
            ...
            <ul class="list-unstyled menu-elements">
                <li>
                    <a href="#otherSections2" data-bs-toggle="collapse" aria-expanded="false" class="" role="button" aria-controls="otherSections">
            ...
            <ul class="list-unstyled menu-elements">
                <li>
                    <a href="#otherSections3" data-bs-toggle="collapse" aria-expanded="false" class="" role="button" aria-controls="otherSections">
